...
Template.Table.onCreated(function(){
    ...
    this.startWithFirstPage = this.data.firstPageStart ? this.data.firstPageStart : false;
    ...
    // obsługa subskrypcji
    this.autorun(() => {
        let selector = this.data.selector ? _.clone(this.data.selector) : {};

        let fields = this.data.fields ? this.data.fields : {};
...
Template.Table.helpers({
    ...
    rows() {
        ...
        let selector = Template.instance().data.selector ? _.clone(Template.instance().data.selector) : {};
