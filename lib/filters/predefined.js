Template.TableFiltersPredefined.events({
    'click a'(e,t) {
        e.preventDefault();
        var filterName = t.data.filter.id ? t.data.filter.id : (t.data.filter.name ? t.data.filter.name : t.data.filter.type);
...
Template.TableFiltersPredefined.helpers({
    ...
    isActive() {
        ...
        var values = Table.filters.get();
        var filterName = Template.instance().data.filter.id ? Template.instance().data.filter.name : (Template.instance().data.filter.name ? Template.instance().data.filter.name : Template.instance().data.filter.type);
